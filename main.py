...
SCRAPERAPI_KEY   = os.environ.get("SCRAPERAPI_KEY",   "200852a0731c4e9f895aee71f892f89b")
...
def fazer_request(url, timeout=30):
    """
    Faz GET na URL com headers rotativos para evitar bloqueios.
    """
    if SCRAPERAPI_KEY:
        params = {
...
def monitorar():
    ...
    scraper_status = "✅ ScraperAPI ativa" if SCRAPERAPI_KEY else "⚠️ ScraperAPI NAO configurada (risco de bloqueio)"
