...
def verificar_show(show):
    ...
    for tentativa in range(tentativas):
        try:
            if tentativa > 0:
                # Delay progressivo mais humano: 15-30s, 30-60s, 60-90s
                base  = 15 * tentativa
            ...
            # Tentativa 0: direto desktop
            # Tentativa 1: direto mobile (diferente fingerprint)
            # Tentativa 2+: ScraperAPI premium
            if tentativa == 0:
                usar_scraper  = False
                usar_mobile   = False
            elif tentativa == 1:
    ...
    while True:
        try:
            ...
            for show in SHOWS:
                ...
                threads.append(t)
                t.start()
                # Pequeno stagger (2-4s) para nao sobrecarregar ScraperAPI
